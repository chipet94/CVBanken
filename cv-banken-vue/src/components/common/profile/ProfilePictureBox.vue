...
<section>
  <figure class="image is-4by4">
    <div class="columns is-centered is-vcentered">
      <div class="column">
        <img class="profilePicture" :src="profilePicture || require('@/assets/stockPhoto.jpg')" alt="Profilbild" @click="pictureClicked">
      </div>
  ...
  <b-modal v-model="isShowing">
    <img class="" :src="profilePicture || require('@/assets/stockPhoto.jpg')" alt="Profilbild">
  </b-modal>
</section>
</template>
